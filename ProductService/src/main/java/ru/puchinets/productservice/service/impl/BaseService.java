...
import ru.puchinets.productservice.mapper.BaseMapper;
import ru.puchinets.productservice.repository.BaseRepository;

import java.util.Optional;

@RequiredArgsConstructor
@Transactional(readOnly = true)
public abstract class BaseService<RQ, RS, T, ID> {
