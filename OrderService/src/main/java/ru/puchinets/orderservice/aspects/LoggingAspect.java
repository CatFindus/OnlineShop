package ru.puchinets.orderservice.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("within(ru.puchinets.orderservice.service.impl.*)")
    public void isServicePackage() {
    }

    @Pointcut("within(ru.puchinets.orderservice.controller.rest.*)")
    ...
    @Pointcut("within(ru.puchinets.orderservice.mapper.*)")
